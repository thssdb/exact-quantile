...
public class FixedTreap_2 {
  ...
  public FixedTreap_2(int bits) { // TODO use bucket when remainingBits is too small(16)
  ...
  private void insertNonRecursive(long num, long freq) {
    ...
    while (x > 0) {//DEBUG++;
      //385646542
//      System.out.println("\t\t\t+  testing x:    "+x+"  value:"+value[x]+"  "+num);
      tmpStack[++tmpStackTop] = x;
...
//    System.out.println("[DEBUG] rebuild SHR="+SHR);
  }
