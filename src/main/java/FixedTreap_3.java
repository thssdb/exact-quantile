...
/**
 * This is a treap with a maximum size.
 * values in treap are treated as unsigned
 * when size meets limit, it will right shift the values and rebuild
 * when bits of values too small, it will become a bucket
 */
public class FixedTreap_3 {
  ...
  public FixedTreap_3(int bits) { // TODO use bucket when remainingBits is too small(16)
  ...
  public FixedTreap_3(int bits, int minBits) { // minBits<bits
