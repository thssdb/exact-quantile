...
public class GCHashMapComplexForQuantile {
  private final int maxSize = /*(1 << 16)+1*/1<<15;
  ...
  GCHashMapAggressiveForQuantile[] aggressiveHashMap;
  boolean[] aggressiveFailed;

  public GCHashMapComplexForQuantile(int bits, int minBits) { // simply 16-bit bucket when remainingBits<=minBits.
  ...
  public GCHashMapComplexForQuantile(int bits, int minBits, double expectedRoughK) {
    ...
    aggressiveLevel = 0;
    aggressiveHashMap = new GCHashMapAggressiveForQuantile[aggressiveMaxLevel];
...
//    System.out.println("[turnToBucket]+remaining:"+remainingBits+"  tot:"+hashMap.size());
  ...
  private void constructAggressiveHashMap() {
    aggressiveHashMap[aggressiveLevel] = new GCHashMapAggressiveForQuantile(
...
//      System.out.println(count[x] + "  " + value[x]);
  ...
  public void reset(int bits, int minBits, double expectedRoughK) {
    ...
    aggressiveLevel = 0;
    aggressiveHashMap = new GCHashMapAggressiveForQuantile[aggressiveMaxLevel]; // TODO re-use memory
    aggressiveFailed = new boolean[aggressiveMaxLevel];
    Arrays.fill(aggressiveFailed, false);
