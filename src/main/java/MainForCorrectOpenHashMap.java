...
public class MainForCorrectOpenHashMap {
    int N = 2000000;
...
//        System.out.println("   start mem:"+(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())/1024/1024);
        ...
        List<Long> result = hashMap.findResultIndex(N/2, N/2+1);
...
//        System.out.println(hashMap.DEBUG);
        System.out.println(hashMap.getRemainingBits());
//        System.out.println("   end mem:"+(Runtime.get/Runtime().totalMemory() - Runtime.getRuntime().freeMemory())/1024/1024);
    }
    public void test4(){
//        System.out.println("   start mem:"+(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())/1024/1024);
        ...
        System.out.println(hashMap.DEBUG);
        System.out.println(hashMap.getRemainingBits());
//        System.out.println("......"+hashMap.isBucket);
//        System.out.println("   end mem:"+(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())/1024/1024);
    }
...
//            }
            ...
            MainForCorrectOpenHashMap main = new MainForCorrectOpenHashMap();
            main.test1();
