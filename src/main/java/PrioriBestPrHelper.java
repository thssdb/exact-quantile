...
public class PrioriBestPrHelper{
  static KLLSketchLazyEmptyForSimuCompact simuWorker=null,simuWorkerSmall1=null,simuWorkerSmall2=null;
  ...
  public PrioriBestPrHelper(int maxMemoryNum,int queryN,int []firstPassCompactNum,int merge_buffer_ratio, int multi_quantile){
    PrioriBestPrHelper.maxMemoryNum=maxMemoryNum;
    simuWorker = merge_buffer_ratio==0?new KLLSketchLazyEmptyForSimuCompact(maxMemoryNum):
        new KLLSketchLazyEmptyForSimuCompact(maxMemoryNum*(merge_buffer_ratio-1)/merge_buffer_ratio);
  ...
  public PrioriBestPrHelper(int maxMemoryNum,int queryN,int merge_buffer_ratio, int multi_quantile){
    PrioriBestPrHelper.maxMemoryNum=maxMemoryNum;
    simuWorker = merge_buffer_ratio==0?new KLLSketchLazyEmptyForSimuCompact(maxMemoryNum):
        new KLLSketchLazyEmptyForSimuCompact(maxMemoryNum*(merge_buffer_ratio-1)/merge_buffer_ratio);
    initialCompactNum = simuWorker.simulateCompactNumGivenN(queryN);
