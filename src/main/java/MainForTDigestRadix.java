...
public class MainForTDigestRadix {
    int N = 20000000,K=1;
...
//        System.out.println("   end mem:"+1.0*(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())/1024/1024);
    ...
    public void test2(){
//        System.out.println("   start mem:"+1.0*(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())/1024/1024);
        TDigestRadixForMedian worker = new TDigestRadixForMedian(com,com*K);
        reset();
        Random random = new Random(233);
        for(int i=1;i<=N;i++) {
            long num=nextLong(),freq=/*Math.abs(nextLong())%23+*/1;
...
//        System.out.println("   end mem:"+1.0*(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())/1024/1024);
    ...
    public void test3(){
//        System.out.println("   start mem:"+1.0*(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())/1024/1024);
        TDigestRadixBetterForMedian worker = new TDigestRadixBetterForMedian(com,com*K, 64);
        reset();
        Random random = new Random(233);
        for(int i=1;i<=N;i++) {
            long num=nextLong(),freq=/*Math.abs(nextLong())%23+*/1;
...
//        System.out.println("   end mem:"+1.0*(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())/1024/1024);
    ...
    public void test4(){
//        System.out.println("   start mem:"+1.0*(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())/1024/1024);
        TDigestRadixBestForMedian worker = new TDigestRadixBestForMedian(com,com*K, 64);
        reset();
        Random random = new Random(233);
        for(int i=1;i<=N;i++) {
            long num=nextLong(),freq=/*Math.abs(nextLong())%23+*/1;
...
//            }
            ...
            MainForTDigestRadix main = new MainForTDigestRadix();
            main.test1();
...
//            }
        ...
        System.out.println("amortized radix: "+sum/TEST_CASE+"ms");
...
//            }
        ...
        System.out.println("amortized radix better: "+sum/TEST_CASE+"ms");
...
//            }
        ...
        System.out.println("amortized radix best: "+sum/TEST_CASE+"ms");
