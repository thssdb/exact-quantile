...
//  long[] sampleValueCount;
  ...
  public SamplerForMedian(int sampleSizeLimit) {
...
//    return random.nextLong();
  ...
  public List<Long> findResultRange(long K1, long K2) {
    ...
    int delta = (int)Math.ceil(Math.pow(Math.log(sampleNum)/Math.log(2.0),2.0)*1.65);
//    int delta = (int)Math.pow(sampleNum,0.33)+100;

//    result.add(sample[posR2-1]);
