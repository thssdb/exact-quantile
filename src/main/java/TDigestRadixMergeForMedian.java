...
public class TDigestRadixMergeForMedian {
  ...
  public TDigestRadixMergeForMedian(int compression, int bufferSizeLimit, byte bitsOfDataType) {
    this.compression = compression;
    this.bufferSizeLimit = bufferSizeLimit;
    buffer = new long[this.bufferSizeLimit];
    bufferNum = 0;
    clusterNum = 0;
    totSize = 0;
